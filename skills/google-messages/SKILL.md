...
metadata:
  version: "0.4.0"
  compatibility: "OpenClaw >=2026.8.1; gmcli >=0.4.0"
  openclaw:
    ...
    install:
      - id: go-install
        kind: go
        module: github.com/fdsouvenir/gmcli@v0.4.0
        bins: ["gmcli"]
        label: Install gmcli v0.4.0 with Go
---
...
Requires **OpenClaw 2026.8.1 (OpenClaw 2.0) or newer** and **gmcli 0.4.0
...
gmcli 0.4.0 or newer; the OpenClaw runtime check applies to OpenClaw use.
